/*
 * GDMLVSystem_VRValves_AltParams.cpp
 *
...
void ParamGdmlvAlt::paramPreloopComputations(double Tc)
{
...
void ParamGdmlvAlt::setDefaultParams()
{
	Nw = 2;
...
void ParamGdmlvAlt::importParams( string prmPrefix, DataContainer & prmData )
{
