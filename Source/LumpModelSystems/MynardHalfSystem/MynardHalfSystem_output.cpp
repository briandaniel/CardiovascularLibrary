...
// print params
void ParamMynardHalf0D::printParams(){

		ParamMynardHalf0D::printParams( paramOutputFile.c_str() );
}
...
// print params
void ParamMynardHalf0D::printParams( string outputFileName ){
