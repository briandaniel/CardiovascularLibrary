...
#include "fiberDirectionFunctions.hpp"
...
void NodeGdmLV::computeFiberRotation( double * es, double * en, double * ef )
{
...
void NodeGdmLV::computeFiberRotation( ParamGdmLV * prm )
{
...
void NodeGdmLV::computeFiberVectors( double * e1, double * e2, double * e3, double * e4, double * es, double * en, double * ef, ParamGdmLV * prm )
{
